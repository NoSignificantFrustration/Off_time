...
public class UIEventHandler : MonoBehaviour
{
    ...
    public static string loginRegex = "[^A-Z¡…Õ”÷’⁄‹€a-z·ÈÌÛˆı˙¸˚0-9_]";
    /// <summary>General regex string</summary>
    public static string textRegex = "[^A-Z¡…Õ”÷’⁄‹€a-z·ÈÌÛˆı˙¸˚0-9 _!?.()-]";
    /// <summary>save regex string</summary>
    public static string saveRegex = "[^A-Z¡…Õ”÷’⁄‹€a-z·ÈÌÛˆı˙¸˚0-9 _.()-]";
